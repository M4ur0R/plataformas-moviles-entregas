...
console.log("crearListaDeNumeros(2,5): ", crearListaDeNumeros(1,3))
...
function filtrarSoloPositivos(listaDeNumeros) {
    return listaDeNumeros.filter((listaDeNumeros) => listaDeNumeros > 0);
}
